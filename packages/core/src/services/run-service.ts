import type { NewRun, Run, RunStep } from "@ants/store";
import { runSteps, runs } from "@ants/store";
import {
	and,
	count,
	desc,
...
export function createRunService(db: PostgresJsDatabase): RunService {
	...
	return { create, getById, list, listAll, updateStatus, cancel, getSteps };
}
