import { zValidator as zodValidator, type Hook } from "@hono/zod-validator";
import { z } from "zod";

// Wrapper that normalizes ZodError responses to 400 (matches @hono/zod-validator default)
export function zValidator(target: Parameters<typeof zodValidator>[0], schema: Parameters<typeof zodValidator>[1]) {
